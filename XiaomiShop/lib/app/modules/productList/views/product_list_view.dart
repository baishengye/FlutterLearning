...
class ProductListView extends GetView<ProductListController> {
  ...
  Widget _goodListWidget(BuildContext context) {
    return Positioned(
      ...
      child: EasyRefresh(
        ...
        child: Obx(() => controller.goodList.isNotEmpty ? ListView.builder(
          padding: EdgeInsets.fromLTRB(26.width, 140.height, 26.width, 26.height),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("￥${controller.goodList[index].price}起",
                              style: TextStyle(
  ...
  Widget _subHeaderWidget(BuildContext context) {
    return Positioned(
      ...
      right: 0,
      top: 0,
      child: Obx(() => controller.goodList.isNotEmpty ? Container(
        width: double.infinity,
        height: 120.height,
        decoration: BoxDecoration(
          color: Colors.white,
